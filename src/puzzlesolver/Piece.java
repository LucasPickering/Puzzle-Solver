...
public class Piece {
   ...
   * equal if for each dir in {@link Direction}, the sides on each piece in that direction match
   * each other, <i>or</i>, one of those sides is {@code null}
   *
  ...
  public static class Builder {
    ...
    /**
     * Sets this piece's side in the given direction to the given side. Makes a copy of the given
     * side to stay safe from bad people.
     *
