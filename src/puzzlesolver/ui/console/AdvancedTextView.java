...
class AdvancedTextView implements TextView {
    ...
    AdvancedTextView(@NotNull Solver solver) {
    ...
    public String[] draw() {
        ...
        return Arrays.stream(builders).map(StringBuilder::toString).toArray(String[]::new);
    }
