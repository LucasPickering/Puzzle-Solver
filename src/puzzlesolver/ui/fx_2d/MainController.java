...
public class MainController extends Application implements Initializable {
    ...
    private void solve() {
        switch (solveButton.getText()) {
            ...
            case UIConstants.BUTTON_STOP:
                puzzleStepperService
                    .cancel(); // Stop the solver (it will do it gracefully I promise)
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        puzzleStepperService
            .setOnRunning(event -> onSolveStarted()); // Called when the solve starts
        puzzleStepperService
            .setOnCancelled(event -> onSolveStopped()); // Called when the solve pauses
        puzzleStepperService
            .setOnSucceeded(event -> onSolveStopped()); // Called when the solve ends
        ...
        rateSlider.valueProperty()
            .addListener((observable, oldValue, newValue) -> updateLoopDelay());
    }
}
