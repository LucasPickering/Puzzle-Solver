...
public class PuzzleControllerTest {
  ...
  public void testGlobalPointFromLocalPoint() throws Exception {
    assertEquals(new Point(UI.VISUAL_PIECE_PADDING, UI.VISUAL_PIECE_PADDING - (UI.VISUAL_PIECE_HEIGHT / 2)),
    ...
    assertEquals(new Point(UI.VISUAL_PIECE_PADDING + (UI.VISUAL_PIECE_WIDTH / 2), UI.VISUAL_PIECE_PADDING),
