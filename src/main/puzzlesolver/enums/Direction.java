...
public enum Direction {
    ...
    /**
     * Constructs a new direction which is in the given x and y direction. If x is 0, then y can be
     * -1 or 1. If y is 0, x can be -1 or 1. No other values are permitted.
     *
